...
#define FLASH_DEVICE DT_LABEL(DT_NODELABEL(en25))
#define CHIP_SIZE    DT_PROP(DT_NODELABEL(en25), size)
#define PAGE_SIZE    DT_PROP(DT_NODELABEL(en25), page_size)
...
#define TEST_AREA_MAX DT_PROP(DT_NODELABEL(en25), size)
