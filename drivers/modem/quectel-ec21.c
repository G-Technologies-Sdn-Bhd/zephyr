...
#define DT_DRV_COMPAT quectel_ec21

#include <zephyr/logging/log.h>
LOG_MODULE_REGISTER(modem_quectel_ec21, CONFIG_MODEM_LOG_LEVEL);

#include "quectel-ec21.h"

static struct k_thread	       modem_rx_thread;
static struct k_work_q	       modem_workq;
static struct modem_data       mdata;
static struct modem_context    mctx;
static struct k_sem sem_rdy;
static const struct socket_op_vtable offload_socket_fd_op_vtable;

static K_KERNEL_STACK_DEFINE(modem_rx_stack, CONFIG_MODEM_QUECTEL_EC21_RX_STACK_SIZE);
static K_KERNEL_STACK_DEFINE(modem_workq_stack, CONFIG_MODEM_QUECTEL_EC21_RX_WORKQ_STACK_SIZE);
...
static const struct modem_cmd response_cmds[] = {
	...
	MODEM_CMD("CONNECT", on_cmd_ok, 0U, ""),
};
...
static const struct setup_cmd setup_cmds[] = {
	...
	/* create PDP context *
	SETUP_CMD_NOHANDLE("AT+CGDCONT=1,\"IP\",\"" CONFIG_MODEM_CELLULAR_APN "\""),
...
NET_DEVICE_DT_INST_OFFLOAD_DEFINE(0, modem_init, NULL,
				  &mdata, NULL,
				  CONFIG_MODEM_QUECTEL_EC21_INIT_PRIORITY,
				  &api_funcs, MDM_MAX_DATA_LENGTH);

/* Register NET sockets. */
NET_SOCKET_OFFLOAD_REGISTER(quectel_ec21, CONFIG_NET_SOCKETS_OFFLOAD_PRIORITY,
