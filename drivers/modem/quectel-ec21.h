...
#define MDM_UNSOL_RDY			CONFIG_MODEM_QUECTEL_EC21_UNSOL_RDY
#define MDM_APN				  CONFIG_MODEM_QUECTEL_EC21_APN
#define MDM_USERNAME			  CONFIG_MODEM_QUECTEL_EC21_USERNAME
#define MDM_PASSWORD			  CONFIG_MODEM_QUECTEL_EC21_PASSWORD
