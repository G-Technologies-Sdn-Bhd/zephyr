...
static off_t offset_528_from_512(off_t offset)
{
	uint16_t npage = offset >> 9;
	uint16_t remainder = offset & (512U - 1U);

	return (npage * 528U) + remainder;
}
			       ...
			       void *data, size_t len)
{
	...
	// offset = offset_528_from_512(offset);
